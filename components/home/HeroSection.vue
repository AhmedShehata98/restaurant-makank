<template>
    <section
        class="bg-app-background-500 hidden lg:flex min-h-screen overflow-x-hidden"
    >
        <div
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {{
                                        $t(
                                            "pages.home.sections.hero.restaurantState.closed.title",
                                        )
                                    }}
                                </h1>
                                <p
...
.hero-image-box {
    ...
    background:
        linear-gradient(to right, black 50%, transparent 50%) 0 0 / 10px 2px
            repeat-x,
        /* top */ linear-gradient(to right, black 50%, transparent 50%) 0 100% /
            10px 2px repeat-x,
        /* bottom */ linear-gradient(to bottom, black 50%, transparent 50%) 0
            0 / 2px 10px repeat-y,
        /* left */ linear-gradient(to bottom, black 50%, transparent 50%) 100%
            0 / 2px 10px repeat-y; /* right */
